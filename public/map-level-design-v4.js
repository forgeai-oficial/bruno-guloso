(()=>{
  ...
  function install(){if(!(window.__BG_ALL_MECHANICS_TEST_V1__&&window.Mario&&Mario.LevelState&&Mario.SpriteTemplate&&Mario.Tile))return false;installSpawnFilter();installHook();try{const st=window.Mario&&Mario.MarioCharacter&&Mario.MarioCharacter.World;if(st)designToEnd(st)}catch(e){}return true}
